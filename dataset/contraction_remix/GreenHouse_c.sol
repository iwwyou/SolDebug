...
contract GreenHouse {
    uint256 constant public FEE_ALL_USERS_STAKED_PERMILLE = 700;
    uint256 constant public FEE_BONUS_POOL_PERMILLE = 100;
    uint256 constant public FEE_PLATFORM_WALLET_PERMILLE = 100;    
    uint256 constant public FEE_REFERRAL_PERMILLE = 50;
