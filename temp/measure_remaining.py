"""
Measure Claim and Dripper contracts
"""
import json
import time
import re
...
# Missing files
remaining_files = [
    ('Claim_c_annot.json', 'Claim', 'Claim', 'getCurrentClaimAmount'),
    ('Dripper_c_annot.json', 'Dripper', 'Dripper', '_availableFunds')
]

new_rows = []

for filename, sol_name, remix_contract, remix_function in remaining_files:
    ...
    try:
        ...
        for delta in [0, 2, 5, 10]:
            ...
            try:
                ...
                print(f'  Delta {delta}: {latency_ms:.2f} ms')
