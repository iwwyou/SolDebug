...
\section{The design of SolQDebug}
    \subsection{System Architecture}
        ...
        Boolean values are modeled as $\{0,1\}$ intervals, and addresses are tracked using a set domain
        (up to 8 symbolic identifiers). Byte arrays and strings remain symbolic throughout. For composite containers such
