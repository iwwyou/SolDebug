...
\section{The design of SolQDebug}
    ...
    \subsection{System Architecture}
        ...
        Following analysis, \textsc{SolQDebug} produces a summary showing computed intervals at key program points: variable declarations, assignments, return values, and loop fixpoints.
        All outputs are mapped to their corresponding source line numbers and displayed inline within the editor, providing immediate feedback as developers write and modify code.
