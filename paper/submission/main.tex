...
the majority had more than 5 years of programming experience (71.4\%) and intermediate or advanced Solidity experience (71.4\%),
including graduate students (47.6\%), researchers (28.6\%), software developers (9.5\%), and professors (4.8\%).
...
\midrule
AI (ChatGPT, Claude, etc.) & 11 (52.4\%) & 98.2\% & 89.6s \\
Calculator & 6 (28.6\%) & 86.7\% & 165.7s \\
Mental calculation only & 3 (14.3\%) & 13.3\% & 93.9s \\
Pen and paper & 1 (4.8\%) & 60.0\% & 199.9s \\
\midrule
...
As shown in Table~\ref{tab:rq4-tools}, participants who did not use AI assistants achieved 62\% accuracy (31/50),
...
However, even with AI assistance, participants spent a median of 89.6 seconds per problem,
...
participants were predominantly from academic backgrounds rather than industry developers,
and a formal usability study evaluating developers' experience with \textsc{SolQDebug} in realistic workflows has not yet been performed.
...
The experimental findings from RQ2 and RQ3 yield actionable strategies for developers to maximize analysis precision. Table~\ref{tab:guidelines} synthesizes these findings into a unified framework that includes annotation strategies for both arithmetic and loops, as well as code design patterns specifically for loop constructs.
    ...
    a formal usability study with industry developers has not yet been performed.
...
\bibitem[Cognition.run(2025)]{cognition}
Cognition.run: \url{https://www.cognition.run/} (2025). Accessed January 2026
