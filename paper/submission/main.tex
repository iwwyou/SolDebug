...
\abstract{As Solidity becomes the dominant language for blockchain smart contracts,
    ...
    \textsc{SolQDebug} was evaluated on 30 real-world functions from DAppSCAN, achieving millisecond-scale feedback.
...
In comparison, \textsc{SolQDebug} analyzed the same functions in 0.08--0.18 seconds (mean: 0.12s, median: 0.10s).
...
\textsc{SolQDebug} addresses this by providing integrated, edit-time feedback within the development environment.
\end{minipage}%
}
...
A formal usability study evaluating developers' experience with \textsc{SolQDebug} in realistic workflows has not yet been performed.
...
This work was supported by the Institute of Information \& communications Technology Planning \& Evaluation (IITP) grants funded by the Korean government (MSIT) (RS-2021-II210177, High Assurance of Smart Contract for Secure Software Development Life Cycle; IITP-2024-RS-2022-II221198, Global Research Support Program in the Digital Field).
