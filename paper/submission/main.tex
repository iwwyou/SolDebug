...
\abstract{As Solidity becomes the dominant language for blockchain smart contracts,
    ...
    To address this challenge, this paper presented SolQDebug,
    ...
    These results demonstrated that SolQDebug serves as an effective edit-time debugging assistant for Solidity development.}
...
\FloatBarrier
    ...
    \subsection{Proposed Approach Overview}
        ...
        Both approaches disrupt iteration. To address this, SolQDebug introduces batch annotations, enabling developers to vary inputs or contract state to observe control-flow outcomes.
...
Compared to other static analyses, dynamic analysis, and machine learning techniques,
