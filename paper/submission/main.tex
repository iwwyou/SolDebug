...
\section{Introduction}\label{sec1}
    ...
    SolQDebug provided abstract value summaries as developers type, enabling exploration of function behavior at the statement level.
...
\midrule
AI (ChatGPT, Claude, etc.) & 11 (52.4\%) & 98.2\% & 43.1s \\
Non-AI & 10 (47.6\%) & 62.0\% & 125.9s \\
\midrule
...
As shown in Table~\ref{tab:rq4-tools}, participants who did not use AI assistants (using calculator, mental calculation, or pen and paper) achieved 62\% accuracy (31/50) with a median time of 125.9 seconds,
indicating that manual value tracing is demanding even for experienced programmers.
In contrast, the majority (52.4\%) relied on AI assistants such as ChatGPT or Claude, achieving 98.2\% accuracy.
...
\begin{minipage}{0.96\linewidth}
\textbf{Answer to RQ4:}
Without AI assistance, participants achieved only 62\% accuracy.
While AI improved accuracy to 98.2\%, it requires external tool workflows.
...
This work was supported by the Institute of Information \& communications Technology Planning \& Evaluation (IITP) grants funded by the Korean government (MSIT) (RS-2021-II210177, High Assurance of Smart Contract for Secure Software Development Life Cycle).
