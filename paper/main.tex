...
during incremental editing (Table~\ref{tab:interactive-rules}),
and one for batch-annotation blocks that enable symbolic input scenarios.
...
Complete grammar specifications, including all production rules and value formats for annotations,
appear in Appendix~\ref{appendix:interactive-grammar}.
