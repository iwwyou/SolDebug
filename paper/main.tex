...
Every insertion operates at the \textsc{current node} without restructuring the rest of the graph. To enable direct insertion, each basic node holds exactly one statement, maintaining a line-to-node mapping.
